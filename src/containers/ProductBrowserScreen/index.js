    ...
    return (
      <View style={styles.webContainer}>
        ...
        <View style={styles.viewAddToCart}>
          <Text style={[{color:'#fff',textAlign:'center',paddingLeft:2,paddingRight:2},mainStyles.TextRegular]}>
            click <Text style={{fontWeight:"bold"}}>"ADD TO CART"</Text> below once you land on your desired item.
          </Text>
