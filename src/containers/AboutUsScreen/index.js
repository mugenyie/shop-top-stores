        ...
        return (
            <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
                ...
                <Text style={[mainStyles.TextRegular,styles.bodyText]}>
                    SHOP TOP STORES (STS) enables you to shop from top stores across the globe. 
                    You will be able to browse through hundreds of official 
                    stores worldwide to make a purchase and have your items shipped to your door step guaranteed by our vetted top shipping providers in your location.
                ...
                <Text style={[mainStyles.TextRegular,styles.bodyText,{paddingBottom:100}]}>
                    <Text style={{fontWeight:'bold'}}>1.</Text> Click our recommended stores to browse products or use our in-app browser to search for your preffered store or to submit a link of your product.{"\n"}
                    <Text style={{fontWeight:'bold'}}>2.</Text> Once you have identified your item, click "ADD TO CART" red button on the screen.{"\n"}
                    ...
                    <Text style={{fontWeight:'bold'}}>4.</Text> You can view orders to check the order status of your items{"\n"}
