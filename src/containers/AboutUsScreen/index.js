        ...
        return (
            <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
                ...
                <Text style={[mainStyles.TextRegular,styles.bodyText,{paddingBottom:100}]}>
                    ...
                    <Text style={{fontWeight:'bold'}}>1.</Text> Click our recommended stores to browse products or use our in-app browser to search for your preffered store or to submit a link to your product.{"\n"}
